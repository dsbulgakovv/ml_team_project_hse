...
df_users.to_sql('users', engine_users, index=False, if_exists='append')

df_items = pd.read_csv('data/items.csv')
engine_items = create_engine(engine)
df_items.to_sql('items', engine_items, index=False)

df_interactions = pd.read_csv('data/interactions.csv')
engine_interactions = create_engine(engine)
df_interactions.to_sql('interactions', engine_interactions, index=False)
